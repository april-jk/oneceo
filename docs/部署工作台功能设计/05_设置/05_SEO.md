...
本次改造目标不是做后台配置页，而是直接补齐官网 SEO 基础设施与首页引流内容。

## 目标

1. 让 Google 能稳定识别 `oneceo` 的品牌名、站点定位与首页入口。
2. 让首页成为唯一主索引落地页，集中承接 “AI Agent platform / AI workflow / task execution / deployment” 相关搜索意图。
...
- 首页补充真实语义化区块，使用 `section / h1 / h2 / h3 / ul` 等可抓取结构。
