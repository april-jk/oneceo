...
- `docs/AGENTS_GUIDE/PROJECT_PROMPT.md`
- 仓库根目录 `AGENTS.md`
- 仓库根目录 `PRODUCT.md` 与 `DESIGN.md`：UI/UX 相关工作必须先读取，默认 register 为 `product`，设计北极星为“任务塔台”，优先服务平台管理员的高密度治理与可复核操作。
- `项目规范文档架构导览（分段文档）`中的文档是更详细的要求。
